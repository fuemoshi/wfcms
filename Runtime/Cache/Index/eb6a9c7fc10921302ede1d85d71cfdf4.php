...
<div class="page_box">
    <div class="pagebg_top">
        <div class="pagebg_bottom" style="padding-bottom:80px;">
            <div class="page_title_line"><img src="__IMAGES__/t_sellers.png" width="187" height="61"></div>
            <!--<div class="page_title_best"><img src="__IMAGES__/t_best1.gif"></div>-->
            <div class="page_best_box">
                <?php if(is_array($result1)): foreach($result1 as $key=>$v): ?><div class="page_best_list_box">
                        <div class="page_best_list_pic">
                            <a href="<?php echo U(GROUP_NAME . '/Index/products_show',array('id'=>$v['id']));?>"><img
                                    src="__UPLOADS__/<?php echo (substr_f($v['images'])); ?>" height="155" width="122" border="0"></a></div>
                        <div class="page_best_list_info_box">
                            <div class="page_best_list_title1"><?php echo ($v["title"]); ?></div>
                            <div class="page_best_list_txt">
            ...
            <div class="c"></div>
            <div class="page_title_best"><img src="__IMAGES__/t_best2.gif"></div>

            <div class="page_best_box">
                <div class="page_best_line_box">
                    <?php if(is_array($result2)): foreach($result2 as $key=>$v): ?><div class="page_best_list_box2">
                            <div class="page_best_list_pic2"><a href="<?php echo U(GROUP_NAME . '/Index/products_show',array('id'=>$v['id']));?>">
                                <img src="__UPLOADS__/<?php echo (substr_f($v['images'])); ?>" width="233" height="146" border="0"></a></div>
                            <div class="page_best_list_info_box2">
                                <div class="page_best_list_title1"><?php echo ($v["title"]); ?></div>
                                <div class="page_best_list_txt2">
                                    <?php echo (htmlspecialchars_decode($v["desc"])); ?>
                                </div>
                            </div>
                        </div>
                        <div class="c"></div><?php endforeach; endif; ?>
                </div>
                <div class="c"></div>
            </div>
