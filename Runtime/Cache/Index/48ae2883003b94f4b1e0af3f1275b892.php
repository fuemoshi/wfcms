    ...
    <div class="page_left_ico">
        <ul>
            ...
            <div class="page_right_box">
                <?php if($category[$parent_id]['images'] != ''): ?><div class="products_right_banner">
                        <img src="__UPLOADS__/<?php echo ($category[$parent_id]["images"]); ?>" width="720" height="286">
                    </div><?php endif; ?>
                <div class="page_pro_so">
                    <div class="page_pro_so_list">
                        <script type="text/javascript">
                            function select1(type, selectValue) {
                                if(selectValue!="")  {
                                    document.selectForm.selectType.value=type;
                                    document.selectForm.selectValue.value=selectValue;
                                    document.selectForm.submit();
                                }
                            }
                        </script>
                        <form action="<?php echo U(GROUP_NAME . '/Index/products');?>" id="searchForm" name="selectForm" style="margin:0; padding:0;" method="post">
                            <input type="hidden" name="pid" value="<?php echo I('pid');?>">
                            <input type="hidden" name="type" value="0">
                            <label for="select"></label>
                            <select name="class1" id="select" class="proclass">
                            ...
                            <select name="class2" id=""  class="proclass">
                    ...
                    <div class="page_path">首页&nbsp;&gt;&nbsp;理肤产品</div>
                </div>
                <div class="page_pro_list_box">

                    <div class="pro_line_box">
                        <?php if(is_array($result)): foreach($result as $key=>$v): ?><div class="page_pro_list">
                                <div class="page_pro_pic">
                                    <a href="<?php echo U(GROUP_NAME . '/Index/products_show',array('id'=>$v['id']));?>">
                                        <img src="__UPLOADS__/<?php echo (substr_f($v['images'])); ?>" height="110" border="0">
                                    </a>
                                </div>
                                <div class="page_pro_info">
                                    <div class="pro_cn_name"><?php echo ($v["title"]); ?></div>
                                    <div class="pro_en_name"><?php echo ($v["title_en"]); ?></div>
                                    <div class="pro_more"><a href="<?php echo U(GROUP_NAME . '/Index/products_show',array('id'=>$v['id']));?>">
                                        <img src="__IMAGES__/more.gif" width="83" height="19" border="0"></a>
                                    </div>
                                </div>
